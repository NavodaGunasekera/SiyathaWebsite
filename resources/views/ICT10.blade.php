                ...
                <div class="tm-col tm-bg-white tm-intro-pad">
                    ...
                    <div class="tm-row tm-content-row">
                        <div class="tm-col-6 tm-intro-col-l">
                            ...
                            විද්‍යුත් ඉංජිනේරු  ක්ෂේත්‍රය, ඉලෙක්ට්‍රොණික් ඉංජිනේරු  ක්ෂේත්‍රය, ස්වයංචල ඉංජිනේරු  ක්ෂේත්‍රය, යාන්ත්‍රික ඉංජිනේරු  ක්ෂේත්‍රය,  </a> 
        ...
        <div id="about" class="popup mfp-with-anim mfp-hide tm-bg-gray">
            ...
            <div class="tm-row tm-about-row">
                ...
                <div class="tm-col tm-about-col">
                    ...
                    <p class="tm-mb-40">
                    ඔහු 2014 වසරේ සිට ආයතනයේ දේශන පවත්වා ඇති අතර, සා/පෙළ තොරතුරු සහ සන්නිවේදන තාක්ෂණය විෂය සදහා  දේශන ඔහු විසින්  පවත්වනු ලබයි. </p></p>
                    <a href="/teacher1" class="tm-btn tm-btn-primary mfp-prevent-close tm-btn-contact tm-mb-40">
                        View Profile
                    </a>
                </div>               
            </div>
