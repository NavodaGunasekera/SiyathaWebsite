...
<html lang="en">
   ...
   <!-- Site Metas -->
   <title>A/L ඉංජිනේරු  තාක්‍ෂණවේදය</title>
                                ...
                                <nav class="navbar navbar-inverse navbar-toggleable-md">
                                    ...
                                    <div class="collapse navbar-collapse justify-content-md-center" id="cloapediamenu">
                                        <ul class="navbar-nav">
                                            ...
                                            <li class="nav-item active">
                                            <a href="/Exam"> උසස් පෙළ විභාගය ලකුණු ලබා දිමේ පටිපාටිය </a>
                                            </li>
                                            <li class="nav-item active">
...
<body>
    <header class="tm-site-header">
      <center>  <h1 class="tm-mt-0 tm-mb-15"><span class="tm-color-primary">ඉංජිනේරු  තාක්ෂණවේදය</span> <span class="tm-color-gray-2"></span></h1> <center>
    ...
    <div class="tm-container">
        ...
        <div id="intro" class="popup mfp-with-anim mfp-hide tm-bg-gray">
            ...
            <img src="images/et1.jpg" alt="Image" class="tm-intro-img">
                <div class="tm-col tm-bg-white tm-intro-pad">
                    <h2 class="tm-color-primary tm-page-title">ඉංජිනේරු තාක්ෂණවේදය</h2> <br>
                    <div class="tm-row tm-content-row">
                        <div class="tm-col-6 tm-intro-col-l">
                            <p>
                            ඉංජිනේරු ක්ෂේත්‍රයට අයත් විවිධ උපක්ෂේත්‍ර වන සිවිල් : ඉංජිනේරු  ක්ෂේත්‍රය, විද්‍යුත් ඉංජිනේරු  ක්ෂේත්‍රය, ඉලෙක්ට්‍රොණික් ඉංජිනේරු  ක්ෂේත්‍රය, ස්වයංචල ඉංජිනේරු  ක්ෂේත්‍රය, යාන්ත්‍රික ඉංජිනේරු  ක්ෂේත්‍රය, 
                                
                            නිෂ්පාදන ඉංජිනේරු  ක්ෂේත්‍රය, ප්‍රමාණ සමීක්ෂණය වැනි ක්ෂේත්‍ර ගණනාවක් පුරා පැතිරුණු විෂය කරුණු මෙම විෂය තුලින් ආවරනය කරනු ලබයි. </p>
                            <p>
        ...
        <div id="testimonials" class="popup mfp-with-anim mfp-hide tm-bg-gray">
            ...
            <div class="tm-testimonials-inner">
                ...
                <div class="tm-row tm-testimonial-row">                
                    ...
                    <h3> 12 ශ්‍රේණිය </h3>
                        <p>
                        1. ඉංජිනේරු  තාක්ෂණවේදයේ සංවර්ධනයෙහි පල දෛනික අවශ‍යතා සපුරා ගැනිමට භාවිතා කරයි.<br>
                        2. ඉංජිනේරුමය කාර්යයන් සඳහා සැලසුම් චිත්‍ර අඳියි. <br>   
                        3. The pythagorean Relation <br>
                        4. Micro Biology <br>
                        5. Power and Its applications <br>
                        6. Dexterity, strength and energy <br>
                        7. Trigonometric Ratios <br> 
                        8. Rotary Motion <br>
                        9. Electracity <br>
                        10. Heat <br>
                        11. Thermal Chemestry <br>
                        12. Reaction Rate <br>
                        13. Biomes <br>
                        14. Polymers <br>
                        15. The Mechanical properties of matter<br>
                        16. fluied kinetics <br>
                        17. Chemical Industry <br>
                        18. Natural Products <br>
                        19. Linear Functions and Botany Functions <br>
                        20. Detailed Statistics <br>
                        21. Computer system <br>
                        22. Computer Manegment System <br> 
                        23. Application Software <br>
                        24. Internet <br>
                        25. How Technology Advances Affect Ecological Balance.
                    ...
                    <div class="tm-col tm-testimonial-col tm-testimonial-col-2">
                        ...
                        <blockquote class="tm-mb-50">
                            ...
                            ⁂පුනරීක්ෂණ දේශන මගින් පසුගිය ප්‍රශ්න පත්‍ර සාකච්චා කරමින් ඉලක්ක ගත ප්‍රශ්න සදහා පිළිතුරු සැපයීමට සිසුන් හුරුකරවනු ලැබීමද, ආදර්ශ ප්‍රශ්න පත්‍ර කට්ටලයක් මගින් ක්‍රමානුකූලව සිසුන් උසස් පෙළ විභාගය සදහා සූදානම් කිරීමක් සිදු කරනු ලැබේ.<br><br>
                    ...
                    <div class="tm-col tm-testimonial-col tm-testimonial-col-2">
                        ...
                        1. ඉංජිනේරු  තාක්ෂණවේදයේ සංවර්ධනයෙහි පල දෛනික අවශ‍යතා සපුරා ගැනිමට භාවිතා කරයි. <br>
                        2. ඉංජිනේරුමය කාර්යයන් සඳහා සැලසුම් චිත්‍ර අඳියි.<br>   
                        3. ආරක්‍ෂාව සහා සෞඛ‍්‍ය තහවුරැ  වු වැඩ පරිසරයක් ගොඩ නගයි. <br>
                        4. ගොඩනැගිලි ඉදිකිරිමි කටයුතු වලදි විධිමත් ශාස්ත්‍රිය තොරතුරැ අනුගමනය කරයි.<br>
                        5. යන්ත්‍රවල ඇතුලත් චලිත ආකාර  <br>
                        6. Dexterity, strength and energy <br>
                        7. Trigonometric Ratios <br> 
                        8. Rotary Motion <br>
                        9. Electracity <br>
                        ...
                        <img src="images/ET15.png" alt="Image" class="tm-mt-35">
                    </div>
                </div>
            </div>            
        </div>
        ...
        <div id="about" class="popup mfp-with-anim mfp-hide tm-bg-gray">
            ...
            <div class="tm-row tm-about-row">
                <div class="tm-col tm-about-col tm-about-left">                    
                    <img src="images/teacher14.png" alt="Image" class="tm-mb-30">
                    <p class="tm-mb-40">
                    Eng චානක මහිල් , "සියත අධ්‍යාපන ආයතනයේ" නිර්මාතෘ සහ අධ්‍යක්ෂවරයාය.
                    </p>
                    <p class="tm-mb-40">
                ...
                <div class="tm-col tm-about-col">
                   ...
                   B.Eng - Conventry University, UK. 
                    </p>
                   
                    <p class="tm-mb-40">
                    ඔහු 2014 වසරේ සිට ආයතනයේ දේශන පවත්වා ඇති අතර, ඉංජිනේරු තාක්ෂණවේදය විෂය සදහා  දේශන ඔහු විසින්  පවත්වනු ලබයි. </p>
                    <a href="/teacher1" class="tm-btn tm-btn-primary mfp-prevent-close tm-btn-next">
                                   View Profile
                                </a>
                </div>               
            </div>
