...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="{{ url('navoda_css/templatemo-misc.css') }}">
    <link rel="stylesheet" href="{{ url('navoda_css/animate.css') }}">
    <link rel="stylesheet" href="{{ url('navoda_css/templatemo-main.css') }}">

    <!-- JavaScripts -->

    <script src="{{ url('navoda_js/jquery-1.10.2.min.js') }}"></script>
    <script src="{{ url('navoda_js/modernizr.js') }}"></script>
  ...
  <link href="https://unpkg.com/aos@2.3.1/dist/aos.css" rel="stylesheet">
   ...
   <!-- light box gallery -->
   <link href="{{url('css/ekko-lightbox.css')}}" rel="stylesheet">
   <!--[if lt IE 9]>
           ...
           <div class="container">
              <div class="row">
               <div class="col-lg-3">
                  <div class="full">
                     <div class="logo">
                     <a href="index.html"><img src="{{url('images/siyatha.png')}}" style="width: 200px; margin-left: 1px;"/></a>
                     </div>
                  </div>
               </div>
                     ...
                     <div class="main_menu">
                        <nav class="navbar navbar-inverse navbar-toggleable-md">
                           ...
                           <ul class="navbar-nav">
                              ...
                              <ul class="navbar-nav">
                                 <li class="nav-item">
                                    <a class="nav-link" href="#"><img src="{{url('images/search_icon.png')}}" alt="#" /></a>
                                 </li>
                              </ul>
                           </div>
                        </nav>
   ...
   <section class="main_full inner_page">
    ...
    <div id="portfolio" class="section-content">
        <div class="container">
            ...
            <div class="row">
                @foreach($images as $image)
                  ...
                  <div data-aos="flip-right" data-aos-easing="ease-out-cubic" data-aos-duration="3000">
                     <div class="card" style=" border-style: solid;  border-width: 5px; box-shadow: 15px 15px 8px 0 rgba(0,0,0,0.2); border-radius: 15px 15px; ">
                        
                        <div class="overlay ">
                            <div class="inner">
                                <a data-rel="lightbox" href="{{url('uploads/'.$image->filename)}}"><img src="{{url('uploads/'.$image->filename)}}" style="width: 100%; height:230px;" ></a>
            ...
            <!-- <a type="button" class="btn " style="background-color:#60b415; border: 20px solid #7f5a35; " href="{{url('/backImageAlbum')}}">Back</a> -->
            <a class="button" href="{{url('/backImageAlbum')}}"><span> Back </span></a> 
        </div>
    </div>
...
<meta name="viewport" content="width=device-width, initial-scale=1">
         ...
         <div class="container">
            <div class="row">
               ...
               <div class="col-md-4 col-sm-12">
                  <a href="index.html"><img class="img-responsive" src="{{url('images/siyatha.png')}}" style= "width: 50%;"/></a>
    ...
    <script src="{{ url('navoda_js/bootstrap.min.js') }}"></script>
    <script src="{{ url('navoda_js/plugins.js') }}"></script>
    <script src="{{ url('navoda_js/jquery.lightbox.js') }}"></script>
    <script src="{{ url('navoda_js/custom.js') }}"></script>
