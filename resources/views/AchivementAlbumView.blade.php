    ...
    <div class="container">
      ...
      <section class="main_full inner_page">
        <div class="container-fluid">
            <div class="row">
                <div class="full">
                    <h3>අපගේ ජයග්‍රහණ ඇල්බම් ගැලරිය</h3>
                </div>
            </div>
        </div>
    </section>
            ...
            @foreach($albums as $album)
                <div class="col-md-3 col-sm-6" style="margin-bottom:30px">
                     <div class="card" style="height:400px; border-style: solid; border-width: 5px; box-shadow: 15px 15px 8px 0 rgba(0,0,0,0.2); border-radius: 15px 15px;">
                        <!-- <a href="{{url('cover_image/'.$album->cover_image)}}"  > -->
                           
                              <a href="{{url('AchivementImage/view/'.$album->id)}}"><img class="cover-image" src="{{url('cover_image/'.$album->cover_image)}}" style="width: 100%; height:200px; border-radius: 10px 45px 0px 0px; "></a>
                              
                              <div class=" p-3 mb-2   " style="text-align:center; background-color: #ffffff; border-radius: 0px 0px 10px 45px; height:100px " >
                                 <h3 class="title" ><a href="{{url('AchivementImage/view/'.$album->id)}}" style=" color:#ffc107;">{{$album->album_name}}</a></h3>
                              </div>
