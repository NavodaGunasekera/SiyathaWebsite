...
<html lang="en">
   ...
   <!-- Site Metas -->
   <title>Teacher Profile -Miss Niroda </title>
...
.shadow-none {
   ...
   <body id="inner_page">
     ...
     <div class = "inner-box" style="margin-left: 200px; margin-right: 200px; box-sizing: content-box; border-radius:10px; margin-top: 40px;">
    ...
    <div class="main-body">
          ...
          <div class="row gutters-sm">
              ...
              <div class="card">
                <div class="card-body">
                  <div class="d-flex flex-column align-items-center text-center">
                    <img src="images/staff/sp2.jpg"  class="rounded-circle" style=" width: 200px; height:200px;">
                    <div class="mt-3">
                      <h4>Miss. Navoda Nimashani</h4>
                      <p class="text-secondary mb-1">Lecturer</p>
                      <p class="text-muted font-size-sm">Bio System Technology</p>
                  
                      <button class="btn btn-outline-primary"><a href="http://127.0.0.1:8000/message">Message</a></button>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="col-md-8">
              ...
              <br>
              <br>
              <div class="row gutters-sm" style="margin-left: 100px ;">
                ...
                <div class="col-sm-6 mb-3">
                  <div class="card h-100">
                    <div class="card-body">
                      ...
                      <div class="sec2">
      <h4 style="font-family: Sans-serif;">Career Summary</h4>
      <p class="sec2-p" style="font-family: Sans-serif;">Miss. Navoda Nimashani is a lecture in the institute and teaches Bio System Technology.</p>
      <br>
      <h4 style="font-family:Sans-serif;">Acedemic Qualifications</h4>
      <p class="sec2-p" style="font-family: Sans-serif;"> B.BST - University of Wayamba (Undergratuate)</p>
    </div>
  </div>
                    </div>
                  </div>
