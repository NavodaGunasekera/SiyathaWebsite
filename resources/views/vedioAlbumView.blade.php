...
<html lang="en">
  <head>
    ...
    <!-- JavaScripts -->
    <script src="navoda_js/jquery-1.10.2.min.js"></script>
...
<section class="main_full inner_page">
        <div class="container-fluid">
            <div class="row">
                <div class="full">
                    <h3>අපගේ වීඩියෝ ඇල්බම් ගැලරිය</h3>
                </div>
            </div>
        </div>
    </section>
  ...
  <div id="portfolio" class="section-content" style="">
        <div class="container">
            ...
            @foreach($albums as $album)
                <div class="col-md-3 col-sm-6"  style="margin-bottom:30px">
                  ...
                  <div data-aos="fade-up" data-aos-duration="2000">
                        <div class=" card "  style=" height:400px; border-style: solid;  border-width: 5px; box-shadow: 15px 15px 8px 0 rgba(0,0,0,0.2); border-radius: 15px 15px;">
                               
                            
                                <a href="{{url('cover_image/'.$album->cover_image)}}"><img class="cover-image" src="{{url('cover_image/'.$album->cover_image)}}" style="width: 100%; height:200px; border-radius: 10px 45px 0px 0px;"></a>
                                    <!--<h4><a data-rel="lightbox" href="navoda_image/item1.jpg">Nulla non enim</a></h4>-->
                                    <!-- <span><a href="{{url('vedio/view/'.$album->id)}}">{{$album->album_name}}</a></span> -->
                                
                                

                            <div class=" p-3 mb-2   " style="text-align:center; background-color:#ffffff; " >
                                <h3 class="title" ><a  style="color:#ffc107;" href="{{url('vedio/view/'.$album->id)}}">{{$album->album_name}}</a></h3>
                            </div>
                        </div>
                  </div>
                </div> <!-- /.col-md-3 -->
