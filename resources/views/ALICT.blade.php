...
<html lang="en">
   ...
   <!-- Site Metas -->
   <title>A/L තොරතුරු සහ සන්නිවේදන තාක්ෂණය</title>
...
<body>
    ...
    <div class="tm-container">
        ...
        <div id="intro" class="popup mfp-with-anim mfp-hide tm-bg-gray">
            ...
            <img src="images/AL.jpg" alt="Image" class="tm-intro-img">
                <div class="tm-col tm-bg-white tm-intro-pad">
                    ...
                    <div class="tm-row tm-content-row">
                        <div class="tm-col-6 tm-intro-col-l">
                            <p>
                            අ.පො.ස. (උ/පෙළ ) හි තොරතුරු හා සන්නිවේදන තාක්ෂණ විෂය නිර්දේශය තොරතුරු හා සන්නිවේදන තාක්ෂණයේ න්‍යායාත්මක හා ප්‍රායෝගික භාවිතය යන දෙකම ආවරණය වන පරිදි තොරතුරු සන්නිවේදන තාක්ෂණයේ මූලික සංකල්ප සන්නිවේදනය කරයි. </p>
                            <p>
                        ...
                        <div class="tm-col-6">
                            ...
                            <p>
                            එසේම මෙම විෂය සඳහා අමතර වාසියක් ලබා දෙනු ඇත,
                            සිසුන්ට ඔවුන්ගේ මෘදු කුසලතා වැඩිදියුණු කිරීමෙන්, එමඟින් වැඩ කරන පරිසරයට වඩාත් ගැලපෙන පරිදි ඔවුන්ට හැකි වේ. 
                            </p>
        ...
        <div id="about" class="popup mfp-with-anim mfp-hide tm-bg-gray">
            ...
            <div class="tm-row tm-about-row">
                ...
                <div class="tm-col tm-about-col">
                    ...
                    <p class="tm-mb-40">
                    ඔහු 2014 වසරේ සිට ආයතනයේ දේශන පවත්වා ඇති අතර, උ/පෙළ තොරතුරු සහ සන්නිවේදන තාක්ෂණය විෂය සදහා  දේශන ඔහු විසින්  පවත්වනු ලබයි. </p></p>
