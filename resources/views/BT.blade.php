...
<html lang="en">
   ...
   <!-- Site Metas -->
   <title>A/L ජෛව පද්ධති තාක්ෂණවේදය</title>
...
.cardnew:hover{
    transform: scale(1.05);box-shadow: 0 10px 20px rgba(0,0,0,.12), 0 4px 8px rgba(0,0,0,.06);
}
           ...
           <div class="container">
              <div class="row">
               <div class="col-lg-3">
                  <div class="full">
                     <div class="logo">
                     <a href="index.html"><img src="images/siyatha.png" style="width: 200px; margin-left: 1px;"/></a>
                     </div>
                  </div>
               </div>
                                ...
                                <nav class="navbar navbar-inverse navbar-toggleable-md">
                                    ...
                                    <div class="collapse navbar-collapse justify-content-md-center" id="cloapediamenu">
                                        <ul class="navbar-nav">
                                            ...
                                            <li class="nav-item active">
                                            <a href="/SFT">තාක්ෂණය සඳහා විද්‍යාව</a>
                                            </li>
                                            <li class="nav-item active">
                                            <a href="/New">ඉංජිනේරු  තාක්‍ෂණවේදය</a>
                                            </li>
                                            <li class="nav-item active">
                                            <a href="/BT">ජෛව පද්ධති තාක්ෂණය</a>
                                            </li>
                                            <li class="nav-item active">
                                            <a href="/Exam"> ලකුණු ලබා දිමේ පටිපාටිය </a>
                                            </li>
                                            <li class="nav-item active">
                                            <a href="/ALICT">තොරතුරු සහ සන්නිවේදන තාක්ෂණය</a>
                                            </li>
                                        </ul>
                                    </div>    
...
<body>
    <header class="tm-site-header">
      <center>  <h1 class="tm-mt-0 tm-mb-15"><span class="tm-color-primary">ජෛව පද්ධති තාක්ෂණවේදය</span> <span class="tm-color-gray-2"></span></h1> <center>
    ...
    <div class="tm-container">
        ...
        <div id="intro" class="popup mfp-with-anim mfp-hide tm-bg-gray">
            ...
            <img src="images/bst1.jpg" alt="Image" class="tm-intro-img">
                <div class="tm-col tm-bg-white tm-intro-pad">
                    <h2 class="tm-color-primary tm-page-title">ජෛව පද්ධති තාක්ෂණවේදය</h2> <br>
                    <div class="tm-row tm-content-row">
                        <div class="tm-col-6 tm-intro-col-l">
                            <p>
                            කෘෂි විද්‍යාව, පරිසර විද්‍යාව, ව්‍යවාහර ජිව විද්‍යාව, යන ප්‍රධාන ක්ෂේත්‍ර  වලදී  නවීන  තාක්ෂණය භාවිතය ඒකාබද්ධ කරමින් මෙම විෂය සකසා ඇත.
                            ජෛව පද්ධති තාක්ෂණය විෂය යටතේ කෘෂිකර්මය, පශු තාක්ෂණය, ආහාර තාක්ෂණය,පසු අස්වනු තාක්ෂණය යන ආදී සංචරක වේ.  
                           </p>
                        ...
                        <div class="tm-col-6">
                            <p>
                            සිද්ධාන්ත වලට අමතරව ප්‍රායෝගීක පරීක්ෂණ මගින් ද සිසුවා ඇගයීමට ලක් කරන අතර
                            </p>
                            <p>
                            ලිඛිත පරීක්ෂණය සදහා ->  70%  කද, <br>  ප්‍රායෝගීක පරීක්ෂණය සදහා ->  30%  කද, <br> වශයෙන් (මේ වන විට) ලකුණු පිරිනැමීමක් සිදු වේ.
                            </p>
            ...
            <div class="tm-row tm-gallery-row">
                <div class="tm-gallery">
                    <div class="tm-gallery-container">                        
                        ...
                        <figure class="effect-chico tm-gallery-item building">
                        <img src="images/ET10.png" width="200" height="300">
                            <figcaption>
                                <p>Chico's main fear was missing the morning bus.</p>							
                            </figcaption>			
                        </figure>
                        ...
                        <figure class="effect-chico tm-gallery-item animal">
                        <img src="images/ET4.png" width="200" height="300">
                            <figcaption>
                                <p>Chico's main fear was missing the morning bus.</p>							
                            </figcaption>			
                        </figure>
                        ...
                        <figure class="effect-chico tm-gallery-item portrait">
                        <img src="images/ET6.png" width="200" height="300">
                            <figcaption>
                                <p>Chico's main fear was missing the morning bus.</p>							
                            </figcaption>			
                        </figure>
                        <figure class="effect-chico tm-gallery-item portrait">
                        <img src="images/ET5.png" width="200" height="300">
                            <figcaption>
                                <p>Chico's main fear was missing the morning bus.</p>							
                            </figcaption>			
                        </figure>
                        <figure class="effect-chico tm-gallery-item portrait">
                        <img src="images/ET8.png" width="200" height="300">
                            <figcaption>
                                <p>Chico's main fear was missing the morning bus.</p>							
                            </figcaption>			
                        </figure>
                        <figure class="effect-chico tm-gallery-item portrait">
                        <img src="images/ET3.png" width="200" height="300">
                            <figcaption>
                                <p>Chico's main fear was missing the morning bus.</p>							
                            </figcaption>			
                        </figure>
                        <figure class="effect-chico tm-gallery-item portrait">
                        <img src="images/ET2.png" width="200" height="300">
                            <figcaption>
                                <p>Chico's main fear was missing the morning bus.</p>							
                            </figcaption>			
                        </figure>
                ...
                <div class="tm-col tm-gallery-right">
                    ...
                    <div class="tm-gallery-right-inner">
                        ...
                        <p>
                        ⁂ වායු සමනය කරන ලද බහු මාධ්‍ය පහසුකම් සහිත දේශන ශාලා තුල දේශන කටයුතු පවත්වනු ලබයි.
                        </p>
                        <p>
                        ⁂ විශය නිර්දේශයට අදාල සියළුම සිද්ධාන්ත උසස් පෙළ විභාගයට මාස 03කට පෙර සම්පූර්ණ කරනු ලබයි.
                        </p>
                        <p>
                        ⁂ සිද්ධාන්ත වලට අමතරව අවශ්‍ය ප්‍රායෝගික පරීක්ෂණද සිදු කරනු ලැබේ.
                        </p>
                        <p>
                        ⁂ සෑම සිසුවෙකු කෙරෙහිම පෞද්ගලිකව අවධානය යොමු කරමින් දේශන කටයුතු සිදු කෙරේ.
                        </p>
                    </div>
                </div>
            </div>
        ...
        <div id="testimonials" class="popup mfp-with-anim mfp-hide tm-bg-gray">
            ...
            <div class="tm-testimonials-inner">
                <h2 class="tm-color-gray tm-testimonial-col tm-page-title">විෂය අන්තර්ගතය</h2>
                <div class="tm-row tm-testimonial-row">                
                    <div class="tm-col tm-testimonial-col">
                        <h3> 12 ශ්‍රේණිය </h3> 
                        <p>
                        1. ජෛව පද්ධති සදහා කාලගුණික තත්ත්ව පිළිබදව අදහස් ඉදිරිපත් කරයි. <br><br>
                        2. ජෛව පද්ධති ආශි‍‍ත පස පිළිබද විමර්ශනය කරයි. <br> <br>  
                        3. බිම් මැනිමෙි සහා පස පිළිබද ව විමාර්ශනය කරයි. <br><br>
                        4. ජෛව පද්ධතිවලදි ජල ප්‍රභව පිළිබද ව විමාර්ශනය කරයි. <br><br>
                        5. ජලයේ ගුණාත්මක බව නිර්ණය කරයි. <br><br>
                        6. වාණිජ මටිටමින් ගුණාත්මක පැළ නිෂ්පාදනය කිරිමෙි සුදානම ප්‍රදර්ශනය කරයි. <br><br>
                        7. උසස් තාක්ෂණික ශිල්ප ක්‍රම යොදා ගනිමින් ජලජ ජිව සමිපත් කර්මාන්තයේ නියැළිමට සුදානම ප්‍රදර්ශනය කරයි.<br> <br>
                        8. උසස් තාක්ෂණික ශිල්ප ක්‍රම යොදා ගනිමින් සත්ත්ව නිෂ්පාදනයේ නියැළිමට සුදානම ප්‍රදර්ශනය කරයි. <br><br>
                        9. ගුණාත්මක ආහාර නිෂ්පාදනය සදහා ක්‍රමවෙිද සැලසුමි කරයි. <br><br>
                        10. උසස් ගුණාත්මක නිෂ්පාදන සදහා පසු අස්වනු තාක්‍ෂණ ශිල්ප ක්‍රම  විමර්ශනය කරයි.   <br><br>
                        11. බෝග වගාව සදහා පාලිත පරිසර තත්ත්ව භාවිතයේ තාක්‍ෂණය පිළිබද ව විමර්ශනය කරයි.<br><br>
                    ...
                    <div class="tm-col tm-testimonial-col tm-testimonial-col-2">
                        <img src="images/s1.jpg" alt="Image" class="tm-mb-30">
                        <blockquote>
                            <p>
                        <br>
                            </p>
                        ...
                        <blockquote class="tm-mb-50">
                            ...
                            ⁂විශය නිර්දේශයට අදාල සියළුම සිද්ධාන්ත උසස් පෙළ විභාගයට මාස 03කට පෙර සම්පූර්ණ කරනු ලබයි. <br> <br>
                            ⁂පුනරීක්ෂණ දේශන මගින් පසුගිය ප්‍රශ්න පත්‍ර සාකච්චා කරමින් ඉලක්ක ගත ප්‍රශ්න සදහා පිළිතුරු සැපයීමට සිසුන් හුරුකරවනු ලැබීමද, ආදර්ශ ප්‍රශ්න පත්‍ර කට්ටලයක් මගින් ක්‍රමානුකූලව සිසුන් උසස් පෙළ විභාගය සදහා සූදානම් කිරීමක් සිදු කරනු ලැබේ.
</p>    
                        </blockquote>  
                        <div class="tm-text-center">
                    ...
                    <div class="tm-col tm-testimonial-col tm-testimonial-col-2">
                        <h3> 13 ශ්‍රේණිය </h3>
                        <p>
                        12. යාන්ත්‍රීකරණයේ සුදානම ප්‍රදර්ශනය කරයි. <br> <br>
                        13. තිරසාර ලෙස දැවමය නොවන නිෂ්පාදන පරිභෝජනය කිරිමෙි සුදානම ප්‍රදර්ශනය කරයි .<br> <br>   
                        14. උචිත තාක්ෂණික ශිල්ප ක්‍රම භාවිතයෙන් වැවිලි බෝග හා සුලු අපනයන බෝග ආශි‍‍ත නිෂ්පාදන සැකසිමෙි සුදානම ප්‍රදර්ශනය කරයි . <br>  <br>
                        15. ක්‍රියාවලි පාලනය ස්වයංක්‍රියකරණය යාන්ත්‍රණය  ගොඩ   නැංවීමේ සුදානම ප්‍රදර්ශනය කරයි . <br> <br>
                        16. විවිධ රැකියාවන් ට අදාළ වෘත්තීමය ආරක්ෂාව හා  සෞඛ්‍යය ක්‍රියාමාර්ග භාවිතා කිරීමේ සුදානම ප්‍රදර්ශනය කරයි .<br> <br>
                        17. උද්‍යාන  විද්‍යාවෙහි නියැලීමේ  සුදානම ප්‍රදර්ශනය කරයි .<br> <br>
                        18. ජෛව පද්ධතිවල තිරසාර සංවර්ධනය සදහා වැදගත් වන පරිසර හිතකාමි ක්‍රමෝපායන් පිලිබදව විමසා බලයි. <br> <br> 
                        19. නිෂ්පාදන සහා ව්‍යාපාර සංවර්ධනය සදහා  අවශ්‍ය කුසලතා දියුණු කරගනී.  <br> <br>
                        
            
                        </p>
                        
                        <img src="images/s2.jpg" alt="Image" class="tm-mt-35">
                    </div>
                </div>
            </div>            
        </div>
        ...
        <div id="about" class="popup mfp-with-anim mfp-hide tm-bg-gray">
            ...
            <h2 class="tm-color-primary tm-about-col tm-mb-40 tm-page-title">ගුරුවරයා ගැන</h2>
            <div class="tm-row tm-about-row">
                <div class="tm-col tm-about-col tm-about-left">                    
                    <img src="images/sp2.jpg" alt="Image" class="tm-mb-30">
                    <p class="tm-mb-40">
                    නවෝදා නිමාෂා මෙනවිය 2016 වසරේ සිට ආයතනයේ දේශන පවත්වා ඇත.  
                    </p>
                    <p class="tm-mb-40">
                ...
                <div class="tm-col tm-about-col">
                    ...
                    B.BST - University of Wayamba (Undergratuate)
                    </p>
                    <p class="tm-mb-40">
                 ඇය ජෛව පද්ධති තාක්‍ෂණය විෂය උගන්වනු ලබයි.</p>
                    <a href="/teacher2" class="tm-btn tm-btn-primary mfp-prevent-close tm-btn-contact tm-mb-40">
                        View Profile
                    </a>
                </div>               
            </div>
        ...
        <div id="contact" class="popup mfp-with-anim mfp-hide tm-bg-gray">
            ...
            <h2 class="tm-contact-col tm-color-primary tm-page-title tm-mb-40">Your Comments</h2>
   ...
   <!-- <div id="time">
උසස් පෙළ 2020, <br> සිද්ධාන්ත :- සිකුරාදා පෙ.ව.  8.00 - ප.ව. 5.00 <br> පුනරීක්ෂණ :- බ්‍රහස්පතින්දා පෙ.ව.  8.00 - ප.ව. 5.00
</div>

<div id="time">
උසස් පෙළ 2021 <br>  සිද්ධාන්ත :- සෙනසුරාදා පෙ.ව. 10.30 - ප.ව. 1.00
</div>

<div id="time">
උසස් පෙළ 2022 <br>  සිද්ධාන්ත :- ඉරිදා පෙ.ව. 10.30 - ප.ව. 1.00
</div>  -->
...
<p >උසස් පෙළ 2020 <br> සිද්ධාන්ත :- සිකුරාදා පෙ.ව.  8.00 - ප.ව. 5.00  </p>
<p > පුනරීක්ෂණ :- බ්‍රහස්පතින්දා පෙ.ව.  8.00 - ප.ව. 5.00</p>
...
<p>උසස් පෙළ 2021  <br>සිද්ධාන්ත :- සෙනසුරාදා පෙ.ව. 10.30 - ප.ව. 1.00</p>
<p> පුනරීක්ෂණ :- බ්‍රහස්පතින්දා පෙ.ව.  8.00 - ප.ව. 5.00</p>
...
<p>උසස් පෙළ 2022  <br> සිද්ධාන්ත :- ඉරිදා පෙ.ව. 10.30 - ප.ව. 1.00</p>
<p> පුනරීක්ෂණ :- බ්‍රහස්පතින්දා පෙ.ව.  8.00 - ප.ව. 5.00</p>
         ...
         <div class="container">
            <div class="row">
               ...
               <div class="col-md-4 col-sm-12">
                  <a href="/siyatha"><img class="img-responsive" src="images/siyatha.png" style= "width: 50%;"/></a>
    ...
    font-size: 22px;
    font-weight: 300;
    letter-spacing: 0;">OUR COURSES</h3>
                  </div>
    ...
    <script src="js/templatemo-script.js"></script>
      ...
      <div class="cpy">
        <div class="container">
           <div class="row">
             <div class="col-md-12">
               <p style="color: black;">Copyright 2021. All Rights Reserved.<a style="color:black;"href=""> Siyatha Higher Education Institute </a></p>
             </div>
